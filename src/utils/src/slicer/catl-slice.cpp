...
int main(int argc, char* argv[])
{
    ...
    // Set the log level
    Logger::set_level(static_cast<LogLevel>(options.log_level));
    ...
    LOGI("Create next slice snapshot:", options.create_next_slice_state_snapshot ? "Yes" : "No");
    ...
    try {
        ...
        if (success) {
            ...
            // Print summary
            std::cout << "\nSummary:" << std::endl;
            std::cout << "  Ledger range: " << stats.start_ledger << " to " << stats.end_ledger << std::endl;
            std::cout << "  Bytes processed: " << stats.bytes_processed << std::endl;
            std::cout << "  Bytes written: " << stats.bytes_written << std::endl;
            std::cout << "  State items processed: " << stats.state_items_processed << std::endl;
            std::cout << "  Start snapshot used: " << (stats.start_snapshot_used ? "Yes" : "No") << std::endl;
            std::cout << "  End snapshot created: " << (stats.end_snapshot_created ? "Yes" : "No") << std::endl;
            std::cout << "  Time taken: " << stats.elapsed_seconds << " seconds" << std::endl;
