...
//     {
//         EVP_MD_CTX_free(ctx);
//         throw HashCalculationException("Failed to initialize SHA-512
//         digest");
//     }
//
...
//     {
//         EVP_MD_CTX_free(ctx);
//         throw HashCalculationException("Failed to update digest with
//         prefix");
//     }
//
...
//                         skips,
//                         " levels");
//                     // We have skipped inners - need to find a leaf to
//                     determine
//                     // the path
